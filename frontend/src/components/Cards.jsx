...
import { changeProduct } from '../reducers/productReducer'
            ...
            {products.map((product) => (
                <motion.div                 
                    ...
                    <motion.div className="maincard-body m-0 p-0 w-100">
                        ...
                        <p className="main-btn_comprar w-100 text-center fw-bold m-0 p-0 text-uppercase" onClick={() => {  dispatch(changeProduct(product))}}><Link className='product-link' to={"/producto"}>comprar</Link></p>
